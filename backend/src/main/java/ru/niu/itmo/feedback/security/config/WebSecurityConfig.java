...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(AccessTokenEntryPoint accessTokenEntryPoint, HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/api/auth/**", "/api/feedback/**").permitAll()
                .antMatchers(HttpMethod.POST,"/api/moderator/**", "/api/color/**").hasAuthority("MODERATOR")
                .antMatchers(HttpMethod.GET,"/api/moderator/**").hasAuthority("MODERATOR")
                .antMatchers(HttpMethod.PUT,"/api/moderator/**").hasAuthority("MODERATOR")
...
//                .antMatchers(HttpMethod.OPTIONS, "/api/site-review/**", "/api/moderator/**", "/api/color/**").permitAll()
