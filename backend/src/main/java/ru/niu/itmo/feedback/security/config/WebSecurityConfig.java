...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(AccessTokenEntryPoint accessTokenEntryPoint, HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers(HttpMethod.POST,"/api/moderator/**").hasAuthority("MODERATOR")
                .antMatchers(HttpMethod.OPTIONS,"/api/moderator/**").permitAll()
                ...
                .antMatchers(HttpMethod.OPTIONS, "/api/site-review/**").hasAuthority("MODERATOR")
